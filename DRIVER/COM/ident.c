 ...
 *
 * $Log: ident.c,v $
 * Revision 1.52  2014/10/30 12:43:56  ch
 * (AUTOCI) Checkin due to new revision 1.59 of fileset COM/DRIVERS/BBIS/d201
 *
 * Revision 1.51  2013/11/05 14:45:15  ts
 * (AUTOCI) Checkin due to new revision 1.58 of fileset COM/DRIVERS/BBIS/d201
 *
